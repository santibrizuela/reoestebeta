    ...
    <div className='w-full'>
        <div className='w-screen h-[30vh] lg:h-[40vh] relative'>
            ...
            <div className='absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2'>
                ...
                <h3 className='text-5xl text-green-500'>Nosotros</h3>
            </div>
        </div>
                    ...
                    <div className="flex justify-center">
                        <div className="flex justify-center md:grid md:grid-cols-2 gap-2">
                            <Link 
                                ...
                                rel="noreferrer"
                            >
                                <FaInstagram className='text-5xl text-green-400'/>
                            </Link>
                            <Link 
                                ...
                                rel="noreferrer"
                            >
                                <AiOutlineFacebook className='text-5xl text-green-400'/>
                            </Link>
                            <Link 
                            ...
                            <Link 
                                ...
                                rel="noreferrer"
                            >
                                <AiOutlineLinkedin className='text-5xl text-green-400'/>
                            </Link>
                        </div>
                    </div>
