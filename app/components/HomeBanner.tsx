...
const HomeBanner = () => {
    return ( 
        <div className="relative bg-gradient-to-t from-green-300 to-green-500 my-8 rounded-md">
            <div className="mx-auto px-8 py-12 flex flex-col gap-2 md:flex-row items-center justify-evenly">
                <div className="mb-8 md:mb-0 text-center ease-in duration-300">
                    <h1 className="text-4xl md:text-6xl font-bold text-green-50 mb-4">Plan de Ahorro</h1>
                    <p className="text-lg md:text-xl text-green-50 mb-2">Comprá tu 0km en</p>
