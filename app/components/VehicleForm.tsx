...
const VehicleForm: React.FC = () => {
  ...
  return (
    <div className='bg-slate-50 mt-16 pt-32 md:pt-20 mb-2' id='planesdeahorroform'>
      <h2 className='m-2 text-center text-green-500 font-bold text-[25px] lg:text-[40px]'>SUSCRIBITE A TU PLAN DE AHORRO</h2>
      ...
      <form className="max-w-[900px] mx-auto p-4 grid grid-cols-1 md:grid-cols-2 gap-4" onSubmit={handleSubmit}>
        ...
        <div className="md:col-span-2 flex justify-center">
          <button
            type="submit"
            className="bg-green-500 text-white p-2 rounded mt-4 w-96"
          >
            Enviar
          </button>
        </div>
